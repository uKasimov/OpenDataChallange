    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    <a href="<?=\yii\helpers\Url::to(['default/index'])?>" class="nav-link active">
                ...
                <li class="nav-item">
                    <a href="<?=\yii\helpers\Url::to(['default/camera'])?>" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<?=\yii\helpers\Url::to(['logs/index'])?>" class="nav-link">
